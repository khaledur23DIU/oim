										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>All Faculties List</header>
														<div class="tools">
													...
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="{{ route('oim.faculty.create') }}" id="addRow"
																		class="btn btn-info">
															...
															<table
																...
																<tbody>
																	...
																	<tr class="odd gradeX">
																		...
																		<td class="left">{!! $faculty->official_id !!}</td>
																		<td>{!! $faculty->name !!}</td>
																		<td class="left">{!! $faculty->department->department_initial !!}</td>
																		<td>{!! $faculty->designation !!}</td>
																		<td><a href="mail:{{$faculty->email}}">
																				{!! $faculty->email !!} </a></td>
																		<td class="left"><a href="tel:{{$faculty->contact}}">{!! $faculty->contact !!}</a></td>
																		<td>
																			<a href="{{ route('oim.faculty.show',$faculty->id) }}"
																				class="btn btn-success btn-xs">
																				<i class="fa fa-eye"></i>
																			</a>
																			<a href="{{ route('oim.faculty.edit',$faculty->id) }}"
																				class="btn btn-primary btn-xs">
																				<i class="fa fa-pencil"></i>
																			</a>
																			<button disabled="true" class="btn btn-danger btn-xs" onclick="deleteFaculty({{ $faculty->id }})">
																				<i class="fa fa-trash-o "></i>
																			</button>
																			<form id="delete-form-{{ $faculty->id }}" action="{{ route('oim.faculty.destroy',$faculty->id) }}" method="POST" style="display: none;">
											                                        @csrf
											                                        @method('DELETE')
											                                </form>
																		</td>
