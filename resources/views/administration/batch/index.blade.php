													...
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="{{ route('oim.batch.create') }}" id="addRow"
																		class="btn btn-info">
															...
															<table
																...
																<tbody>
																	...
																	<tr class="odd gradeX">
																		...
																		<td class="left">{!! $batch->batch !!}</td>
																		<td> @foreach ($batch->departments as $department)
																			{!! $department->department_name !!}
																		@endforeach </td>
																		<td>
																			<a href="{{ route('oim.batch.show',$batch->id) }}"
																				class="btn btn-success btn-xs">
																				<i class="fa fa-eye"></i>
																			</a>
																			<a href="{{ route('oim.batch.edit',$batch->id) }}"
																				class="btn btn-primary btn-xs">
																				<i class="fa fa-pencil"></i>
																			</a>
																			<button disabled="true" class="btn btn-danger btn-xs" onclick="deleteBatch({{ $batch->id }})">
																				<i class="fa fa-trash-o "></i>
																			</button>
																			<form id="delete-form-{{ $batch->id }}" action="{{ route('oim.batch.destroy',$batch->id) }}" method="POST" style="display: none;">
											                                        @csrf
											                                        @method('DELETE')
											                                </form>
																		</td>
